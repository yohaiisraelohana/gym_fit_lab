  ...
  return (
    ...
    <div 
        className={`
            ...
            bg-cover bg-right bg-[url("https://res.cloudinary.com/dftounwvk/image/upload/v1697545522/Default_Muscular_man_posing_back_look_standing_bit_far_0_17a12161-3ace-4da6-afb3-50f407c2cd38_0_1_boggst.png")]`}>
        ...
        <button className='mr-1 mt-[15%] lg:mt-[16%]'>ישבן</button>
