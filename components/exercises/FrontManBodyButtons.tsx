...
export default function FrontManBodyButtons() {
  return (
    ...
    <div 
        ...
        <button className='ml-9 mt-[37%] lg:ml-12  lg:mt-[38%]'>כתפיים</button>
        <button className='ml-9 mt-[1%]  lg:ml-12 lg:mt-[3%]'>חזה</button>
        <button className='ml-9 mt-[1%]  lg:ml-12 lg:mt-[1%]'>יד קדמית</button>
        <button className='ml-9 mt-[1%]  lg:ml-12 lg:mt-[3%]'>בטן</button>
        <button className='ml-9 mt-[2%]  lg:ml-12 lg:mt-[2%]'>אמות</button>
        <button className='ml-9 mt-[10%] lg:ml-12 lg:mt-[13%]'>מקרבי ירך</button>
        <button className='ml-9 mt-[3%]  lg:ml-12 lg:mt-[4%]'>ארבע ראשי</button>
    </div>
    </div>
