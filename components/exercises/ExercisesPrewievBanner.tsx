...
export default async function ExercisesPrewievBanner() {
    ...
    if(!data || sRes.error)
        return <></>;
  return (
    <div className='text py-2 flex max-md:flex-col items-center gap-2 max-w-[100vw] lg:px-6 xl:pr-10 bg-gradient-to-bl from-background to-neutral-300 from-40% border-b-2 border-primary '>
